...
import ca.on.oicr.gsi.provenance.GenericAnalysisProvenanceProvider;
...
public class GenericClientIT {
    ...
    public void setup() throws IOException {
        ...
        Map<String, String> analysisProvenanceProviderSettings = new HashMap<>();
        analysisProvenanceProviderSettings.put("url", te.getSeqwareConfig().get("SW_REST_URL") + "/reports/analysis-provenance");
        analysisProvenanceProviderSettings.put("user", te.getSeqwareConfig().get("SW_REST_USER"));
        analysisProvenanceProviderSettings.put("password", te.getSeqwareConfig().get("SW_REST_PASS"));

        dpc.registerAnalysisProvenanceProvider("seqware", GenericAnalysisProvenanceProvider.getProvider(analysisProvenanceProviderSettings));
        ...
        analysisProvider.setType(GenericAnalysisProvenanceProvider.class.getCanonicalName());
        analysisProvider.setProviderSettings(analysisProvenanceProviderSettings);
