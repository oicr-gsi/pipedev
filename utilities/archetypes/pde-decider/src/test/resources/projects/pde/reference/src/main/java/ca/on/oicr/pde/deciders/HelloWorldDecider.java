 ...
 */
public class HelloWorldDecider extends OicrDecider {
     ...
     * <code>java -jar Decider_${project.version}_${project.workflow-name}_1.0_SeqWare_${seqware-version}-jar-with-dependencies.jar --wf-accession 000000 --study Test --test</code> 
     */
	...
	if (ArrayUtils.contains(args,"--verbose")){
        ...
        params.add("--plugin");
        params.add(HelloWorldDecider.class.getCanonicalName());
        params.add("--");
