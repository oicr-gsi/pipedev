...
public class WorkflowRunReportTest {
    ...
    public void testWorkflowRunReportCompare() {
        ...
        FileProvenanceReportRecord f1 = new FileProvenanceReportRecord.Builder().setExperimentName("Test1").setFilePath("/tmp/1").setFileSwid("1").build();
        FileProvenanceReportRecord f2 = new FileProvenanceReportRecord.Builder().setExperimentName("Test2").setFilePath("/tmp/2").setFileSwid("2").build();
