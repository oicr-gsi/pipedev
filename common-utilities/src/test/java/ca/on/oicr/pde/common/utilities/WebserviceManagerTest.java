...
/** The test cases for webservice manager
 * The following test cases are included: creating a service then destroying it
 * creating multiple webservices
 * destroying multiple webservices
 * attempting to destroy a webservice that doesn't exist
 * ensuring that proper procedure is carried out incase the engine decides to cancel the job
 * @author Raunaq Suri
 *.
 */
public class WebserviceManagerTest 
{
    ...
    String port = "5432" ;
    String user = "sqwci";
    String pass = "Nie4Neon";
    String seqDir = "~/seqware/seqware-webservice/";
